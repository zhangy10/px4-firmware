...
#define ICM20648_SPI_DIR_WRITE           0x7F
#define ICM20648_SPI_DIR_READ            0x80

/**@}*/

/** @endcond */

#define ICM20648_TIMER_REDUCTION				200

// 250 dps, full scale range 2^15
#define ICM20648_GYRO_INITIAL_SCALE                            (M_PI_F / (180.0f * (32768.0f/250.0f)))

class ICM20648:  public device::SPI, public px4::ScheduledWorkItem
{
public:
	ICM20648(int bus, uint32_t device, enum Rotation rotation);
	virtual ~ICM20648();
