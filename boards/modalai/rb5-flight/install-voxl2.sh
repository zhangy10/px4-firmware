...
adb push min-m0054.config /etc/modalai
adb push full-m0054.config /etc/modalai
adb push m0054-set-default-parameters.config /etc/modalai
adb push qgc-ip.cfg /etc/modalai
adb push m0054-px4 /usr/bin
